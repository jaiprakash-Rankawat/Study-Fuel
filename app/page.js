      ...
      <div className="bg-gray-900 text-white">
        ...
        <section className="relative w-full h-screen flex flex-col justify-center items-center text-center px-6">
          <h1 className="text-4xl md:text-6xl font-extrabold">
            Welcome to <span className="text-blue-500">Study Fuel</span>
          </h1>
          <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-2xl">
            Your go-to platform for mastering web development and staying ahead
            in the tech world.
          </p>
          <Link
            href="/study-material"
            className="mt-6 px-6 py-3 bg-blue-500 hover:bg-blue-600 text-white text-lg font-semibold rounded-md flex items-center gap-2 transition"
          >
        ...
        <section className="py-16 px-6 text-center">
          ...
          <p className="mt-4 text-lg text-gray-300 max-w-2xl mx-auto">
            Join thousands of learners and take your web development skills to
            the next level.
          </p>
